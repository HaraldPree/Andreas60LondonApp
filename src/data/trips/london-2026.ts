...
export const londonTrip: Trip = {
  ...
  days: [
    ...
    },
    {
      ...
      color: "#E5A00D",
      summary:
        "Vormittag wie geplant gelaufen: Leinster-Square-Statuen → Trafalgar → Big Ben → Westminster → Buckingham → Cedric Grolet. Nach Cedric viel zu satt — bewusste Pause, Rest des Tages bleibt offen.",
      ...
      items: [
        {
          ...
          note: "Start gleich beim Hotel — schöne Foto-Stopps.",
        },
        {
          time: "Vormittag",
        ...
        },
        {
          ...
          note: "Das süße Herzstück für Andreas 60er — durchgezogen und genossen. Reservierung 436JUJ35U7YV.",
          bookingUrl: "https://www.the-berkeley.co.uk/restaurants-and-bars/cedric-grolet/",
        },
        {
          time: "Nachmittag",
          label: "🛋️ Pause & Rückweg ins Apartment",
          type: "free",
          icon: "🏨",
          note: "Bewusste Entscheidung um ca. 14:30 zurückzukehren — nach dem reichlichen goûtea + Vormittag-Walk braucht's einfach Erholung.",
        },
        {
          time: "Offen",
          label: "Rest des Tages — nach Stimmung",
          type: "free",
          icon: "🎲",
          note: "Nichts mehr fix geplant. Ideen in der Nähe (5–15 Min vom Hotel): Kensington Gardens / Hyde Park Spaziergang, kurze Notting-Hill-Runde (Portobello Road), V&A wenn doch nochmal Lust auf Kultur, oder einfach im Apartment ausruhen. Abendessen: Bayswater (Queensway/Westbourne Grove) oder Notting Hill — kein Anfahrtsweg nötig.",
        },
      ],
      mapPoints: [
      ...
      tips: [
        "🎂 Cedric Grolet (13:00) ist gelaufen — Andreas süße 60er-Krönung ist im Kasten.",
        "Realtalk: Nach Royal Walk + goûtea ist man kaputt. Rest des Tages bewusst offen gelassen — kein Programm-Druck.",
        "Wer doch nochmal raus mag: Notting Hill / Portobello (5–10 Min vom Hotel), Kensington Gardens (5 Min), V&A oder Natural History Museum (10 Min) — alles freiwillig.",
        "Abendessen: ohne Anfahrt direkt in Bayswater / Notting Hill — viele Pubs & Restaurants in Gehweite.",
      ],
    },
    {
      date: "Mi, 20. Mai",
  ...
  alternativeDays: [
    ...
    null,
    // Index 1 (Di, 19. Mai) — Regen blieb aus, Royal Walk + Cedric durchgezogen, Rest offen.
    // Keine Alternative mehr nötig → null. Original-Tag wurde live (19.05.) angepasst.
    null,
  ...
  alternativeDaysMeta: {
    label: "Sonnentag-Bündelung (Do)",
    description:
      "Donnerstag wird der schönste Tag der Woche → Greenwich-Vormittag per Thames Clipper + Notting Hill am späten Nachmittag kombiniert. (Die ursprünglich geplante Regen-Variante für Dienstag ist obsolet — Regen blieb aus, Royal Walk lief wie original.)",
    source: "KI-Companion, 21.05.2026",
    affectedDayIndices: [3],
  },
