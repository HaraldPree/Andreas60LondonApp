...
export const londonTrip: Trip = {
  ...
  // v1.14.0 — alternativeDays + alternativeDaysMeta + defaultVariant entfernt.
  // Die Leger-Variante (v1.6.0/1.7.7) hat ihren Job während der Live-Reise
  // erfuellt — nach Reise-Ende ist sie verwirrend. Der neue Erlebt-Rueckblick
  // (ProgrammTab v1.14.0) zeigt aus Foto-EXIF rekonstruiert was tatsaechlich
  // passiert ist.
  reservations: [
    {
      id: "cedric-grolet",
