...
export const londonTrip: Trip = {
  ...
  days: [
    ...
    },
    {
      date: "Do, 21. Mai",
      isoDate: "2026-05-21",
      title: "Greenwich per Boot + Royal Observatory",
      icon: "🚣",
      color: "#2D8F5E",
      summary:
        "Themse-Boot nach Greenwich (Aussicht inkl.), Cutty Sark, Greenwich Market, Royal Observatory mit der berühmten Skyline-Aussicht. Entspannt, ohne Canary Wharf-Schleife.",
      weatherHint: "freundlich",
      items: [
        {
          time: "09:30",
        ...
        {
          time: "10:30",
          label: "Tube → Embankment Pier",
          type: "transport",
          icon: "🚇",
          coordinates: { lat: 51.5074, lng: -0.1219 },
          note: "Circle/District ~15 Min.",
        },
        {
          time: "11:00",
          label: "⛴️ Thames Clipper → Greenwich (45 Min Boot)",
          type: "transport",
          icon: "⛴️",
          highlight: true,
          coordinates: { lat: 51.5074, lng: -0.1219 },
        ...
        {
          time: "12:30",
          label: "🛍️ Greenwich Market — Mittag direkt am Markt",
          type: "food",
          icon: "🛍️",
          highlight: true,
        ...
        {
          time: "14:00",
          label: "🌍 Royal Observatory & Prime Meridian (Hügel hoch)",
          type: "activity",
          icon: "🌍",
          highlight: true,
        ...
        {
          time: "15:30",
          label: "Bergab durch Greenwich Park — entspannt",
          type: "activity",
          icon: "🌳",
        ...
        {
          time: "16:00",
          label: "DLR Greenwich → Bank → Tube Apartment",
          type: "transport",
          icon: "🚇",
      ...
      mapPoints: [
        { name: "Embankment Pier", coordinates: { lat: 51.5074, lng: -0.1219 }, category: "transport", icon: "⛴️" },
        { name: "Cutty Sark", coordinates: { lat: 51.4827, lng: -0.0096 }, category: "sight", icon: "⛵" },
        { name: "Greenwich Market", coordinates: { lat: 51.4814, lng: -0.0099 }, category: "food", icon: "🛍️" },
      ...
      tips: [
        "Thames Clipper ist das Highlight von heute — sitzt draußen wenn's geht.",
        "Royal Observatory-Hügel: bequeme Schuhe! Aber dafür die postkarten-perfekte London-Skyline.",
        "Greenwich Market = Mittag direkt am Markt (Streetfood). Mi–So geöffnet.",
        "Canary Wharf + Crossrail Roof Garden + Painted Hall bewusst gestrichen. Wer das ursprüngliche Vollprogramm sehen will: oben auf 'Original-Programm' umschalten.",
      ],
    },
    {
      date: "Fr, 22. Mai",
