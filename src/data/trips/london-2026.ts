...
export const londonTrip: Trip = {
  ...
  alternativeDays: [
    ...
    null,
    // Index 1 (Di, 19. Mai) — RAIN-VARIANTE
    {
      date: "Di, 19. Mai",
      isoDate: "2026-05-19",
      title: "Regen-Variante: kurzer Royal Walk + Cedric + V&A",
      icon: "🌧️",
      color: "#E5A00D",
      summary:
        "Wegen Regen kürzerer Royal Walk am Vormittag, 13:00 Cedric Grolet (unverändert), Nachmittag indoor im V&A Museum. Notting Hill verschoben auf Donnerstag (Sonnentag).",
      weatherHint: "Regen 12–17°C — Schirme mit, Indoor-Programm am Nachmittag",
      items: [
        {
          time: "10:30",
          label: "Abmarsch Apartment → Piccadilly Circus",
          type: "transport",
          icon: "🚶",
          coordinates: { lat: 51.5101, lng: -0.1342 },
          note: "15 Min via Regent Street. Schirme nicht vergessen!",
        },
        {
          time: "10:50",
          ...
          note: "Foto-Stopp, kein langes Verweilen wegen Regen.",
        },
        {
          time: "11:15",
          label: "The Mall → St. James's Park",
          type: "activity",
          icon: "🌳",
          note: "Trotz Regen kurz durch — sehr fotogen mit Schirmen.",
        },
        {
          time: "11:45",
          label: "Buckingham Palace (außen)",
          type: "activity",
          icon: "💂",
          coordinates: { lat: 51.5014, lng: -0.1419 },
          note: "Nur Außenfoto, weiter — Big Ben und Westminster lassen wir heute aus (zu großer Umweg im Regen).",
        },
        {
          time: "12:00",
          label: "Green Park → Hyde Park Corner → Knightsbridge",
          type: "activity",
          icon: "🌳",
          note: "Direktroute zum Berkeley, alles ~10-15 Min.",
        },
        {
          time: "12:45",
          label: "Ankunft Berkeley Hotel – 5 Min Puffer",
          ...
          icon: "🏨",
          coordinates: { lat: 51.5014, lng: -0.1525 },
          note: "Trockenshakes + Schirme abgeben.",
        },
        {
          time: "13:00",
          label: "🎂 FIXPUNKT: Cedric Grolet @ The Berkeley Cafe (goûtea)",
        ...
        {
          time: "ca. 15:00",
          label: "Walking zu den Museen (5–10 Min)",
          type: "transport",
          icon: "🚶",
          note: "Vom Berkeley via Brompton Road, größtenteils überdacht/Arkaden.",
        },
        {
          time: "15:15–17:30",
          label: "V&A Museum",
          ...
          highlight: true,
          coordinates: { lat: 51.4966, lng: -0.1722 },
          note: "Mode, Design, Schmuck, Skulpturen. Vielfältig + kuratiert. Eintritt gratis. Alternative wenn lieber Dinos: Natural History Museum nebenan (auch gratis).",
        },
        {
          time: "Abend",
          label: "Pub-Dinner in Soho (kurze Wege bei Regen)",
          type: "food",
          icon: "🍻",
          note: "The Toucan / Lyric Soho / Old Coffee House — alles in 5–10 Min Tube von South Kensington (Piccadilly Line).",
        },
      ],
      mapPoints: [
        { name: "Piccadilly Circus", coordinates: { lat: 51.5101, lng: -0.1342 }, category: "sight", icon: "🎯" },
        { name: "Trafalgar Square", coordinates: { lat: 51.508, lng: -0.1281 }, category: "sight", icon: "🦁" },
        { name: "Buckingham Palace", coordinates: { lat: 51.5014, lng: -0.1419 }, category: "sight", icon: "💂" },
        { name: "Cedric Grolet @ Berkeley", coordinates: { lat: 51.5014, lng: -0.1525 }, category: "food", icon: "🥐" },
        { name: "V&A Museum", coordinates: { lat: 51.4966, lng: -0.1722 }, category: "sight", icon: "🏛️" },
        { name: "Natural History Museum", coordinates: { lat: 51.4967, lng: -0.1764 }, category: "sight", icon: "🦖" },
      ],
      tips: [
        "🌧️ Regen-Modus: Schirme, wasserdichte Schuhe, Indoor-Programm am Nachmittag.",
        "🎂 Cedric um 13:00 (goûtea Afternoon Tea, Service 12:00–16:30) – 5 Min vorher da, Reservierungs-Nr. 436JUJ35U7YV griffbereit.",
        "Big Ben/Westminster heute aus dem Programm – zu großer Umweg im Regen.",
        "Notting Hill auf Donnerstag verschoben (besseres Wetter, viel schönere Outdoor-Fotos).",
    ...
    // Index 3 (Do, 21. Mai) — KOMBINIERT Greenwich + Notting Hill
    {
      date: "Do, 21. Mai",
      isoDate: "2026-05-21",
      title: "Greenwich + Notting Hill (Sonnentag, kombiniert)",
      icon: "☀️",
      color: "#2980B9",
      summary:
      ...
      items: [
        ...
        {
          time: "10:30",
          label: "Thames Clipper Westminster → Greenwich",
          type: "transport",
          icon: "⛵",
        ...
        {
          time: "11:15",
          label: "Cutty Sark + Greenwich Market",
          type: "activity",
          icon: "⛵",
          coordinates: { lat: 51.4825, lng: -0.0098 },
          note: "Historisches Tee-Clipper-Schiff + lebendiger Markt mit Street Food.",
        },
        {
          time: "12:30",
          label: "Lunch im Greenwich Market",
          type: "food",
          icon: "🥖",
          note: "Internationale Stände – jeder findet was. Sonnige Plätze draußen.",
        },
        {
          time: "13:30",
          label: "Royal Observatory + Prime Meridian",
          ...
          highlight: true,
          coordinates: { lat: 51.4769, lng: -0.0005 },
          note: "Hügelaufstieg lohnt sich – beste Aussicht über London. Foto: ein Fuß auf jeder Halbkugel.",
        },
        {
          time: "14:30",
          label: "Painted Hall (Old Royal Naval College)",
          type: "activity",
          icon: "🎨",
          coordinates: { lat: 51.483, lng: -0.0066 },
          note: "Britisches Sistine Chapel – Decken-Fresken von James Thornhill.",
        },
        {
          time: "ca. 15:30",
        ...
        {
          time: "17:00",
          label: "Portobello Road + bunte Häuser",
          type: "activity",
          icon: "🌈",
          highlight: true,
          coordinates: { lat: 51.5165, lng: -0.2056 },
          note: "Pastellfarbene Häuserreihen im Abendlicht – Instagram-Klassiker. Antiquitäten-Marktbude (Donnerstag teilweise offen).",
        },
        {
          time: "Abend",
          label: "Pub-Dinner Notting Hill",
          type: "food",
          icon: "🍻",
          note: "The Cock & Bottle (gemütlich) oder Ladbroke Arms (Gastropub mit Garten falls warm).",
        },
      ],
      mapPoints: [
        { name: "Westminster Pier", coordinates: { lat: 51.5012, lng: -0.1227 }, category: "transport", icon: "⛵" },
        { name: "Cutty Sark", coordinates: { lat: 51.4825, lng: -0.0098 }, category: "sight", icon: "⛵" },
        { name: "Greenwich Market", coordinates: { lat: 51.4811, lng: -0.0094 }, category: "food", icon: "🥖" },
        { name: "Royal Observatory", coordinates: { lat: 51.4769, lng: -0.0005 }, category: "sight", icon: "🕐" },
        { name: "Painted Hall", coordinates: { lat: 51.483, lng: -0.0066 }, category: "sight", icon: "🎨" },
        { name: "Crossrail Roof Garden (optional)", coordinates: { lat: 51.5054, lng: -0.0192 }, category: "sight", icon: "🌿" },
        { name: "Portobello Road", coordinates: { lat: 51.5165, lng: -0.2056 }, category: "sight", icon: "🛒" },
        { name: "Notting Hill (Pastell-Häuser)", coordinates: { lat: 51.5093, lng: -0.1957 }, category: "sight", icon: "🌈" },
      ],
      tips: [
  ...
  alternativeDaysMeta: {
    label: "Wetter-Variante",
    description:
      "Anpassung an die aktuelle Wetterprognose: Dienstag Regen → Indoor-Programm + V&A statt Notting Hill. Donnerstag schönster Tag → Greenwich + Notting Hill kombiniert.",
    source: "KI-Companion, 21.05.2026",
    affectedDayIndices: [1, 3],
  },
  defaultVariant: "alternative",
