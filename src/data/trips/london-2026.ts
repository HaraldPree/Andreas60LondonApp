...
export const londonTrip: Trip = {
  ...
  days: [
    ...
    // ───────────────────────────────────────────────────────────
    // v1.14.2 — Tage 1-3 sind das ORIGINAL geplante Programm
    // (Hyde Park / Tower of London / Greenwich-Vollprogramm).
    // War davor im alternativeDays gespeichert, die Leger-Version
    // (verkürzte gefahrene Variante) ist entfernt — der Erlebt-
    // Rückblick (Foto-EXIF) ersetzt sie strukturell besser.
    // ───────────────────────────────────────────────────────────
    {
      date: "Di, 19. Mai",
      isoDate: "2026-05-19",
